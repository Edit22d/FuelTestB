...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social_django.context_processors.backends',  # Social auth context
...
AUTHENTICATION_BACKENDS = [
    ...
    'social_core.backends.apple.AppleIdAuth',    # Apple Sign In
    'django.contrib.auth.backends.ModelBackend',  # Default
    'api.authentication.PhoneNumberBackend',      # Custom phone number backend
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'nabwireedith18@gmail.com'
EMAIL_HOST_PASSWORD = 'obdglixrhmwvtgko'
